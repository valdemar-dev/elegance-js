...
export default function Arrow(width: number, height: number, className: string = "") {
    return raw(`
        <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
<svg width="${width}px" class="${className}" height="${height}px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
