let url = "/";
export const data = { state: [{ id: 4, value: function anonymous(state, event) {
  ((event2) => {
...
} }, { id: 5, value: false }, { id: 6, value: false }, { id: 7, value: "" }, { id: 8, value: function anonymous2(state, event) {
  ((_, isOpen2) => {
    isOpen2.value = false;
    isOpen2.signal();
  })(event, ...state.getAll([{ id: 6 }]));
} }, { id: 9, value: function anonymous3(state, event) {
  ((_, isOpen2) => {
    isOpen2.value = !isOpen2.value;
    isOpen2.signal();
  })(event, ...state.getAll([{ id: 6 }]));
} }, { id: 10, value: function anonymous4(state, event) {
  ((_, useDarkMode2) => {
    useDarkMode2.value = false;
    useDarkMode2.signal();
  })(event, ...state.getAll([{ id: 5 }]));
} }, { id: 11, value: function anonymous5(state, event) {
  ((_, useDarkMode2) => {
    useDarkMode2.value = true;
    useDarkMode2.signal();
  })(event, ...state.getAll([{ id: 5 }]));
} }], soa: [{ "id": 9, "key": 2, "attribute": "onclick" }, { "id": 8, "key": 4, "attribute": "onclick" }, { "id": 4, "key": 5, "attribute": "onclick" }, { "id": 8, "key": 6, "attribute": "onclick" }, { "id": 4, "key": 7, "attribute": "onclick" }, { "id": 8, "key": 8, "attribute": "onclick" }, { "id": 4, "key": 9, "attribute": "onclick" }, { "id": 8, "key": 10, "attribute": "onclick" }, { "id": 4, "key": 11, "attribute": "onclick" }, { "id": 8, "key": 12, "attribute": "onclick" }, { "id": 4, "key": 13, "attribute": "onclick" }, { "id": 10, "key": 14, "attribute": "onclick" }, { "id": 11, "key": 15, "attribute": "onclick" }], ooa: [{ key: 1, attribute: "class", update: (value) => {
  ...
  return classList;
}, refs: [{ id: 5 }] }, { key: 3, attribute: "class", update: (value) => {
...
})(state, ...state.getAll([{ id: 5 }])) }, { fn: (state) => ((state2, toastContent2) => {
