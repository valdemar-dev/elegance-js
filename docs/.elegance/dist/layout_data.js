...
} }, { id: 8, value: function anonymous2(state, event) {
  ((_, isOpen2) => {
    isOpen2.value = false;
    isOpen2.signal();
  })(event, ...state.getAll([{ id: 4 }]));
...
} }, { id: 12, value: function anonymous6(state, event) {
  ((_, isOpen2) => {
    isOpen2.value = false;
    isOpen2.signal();
  })(event, ...state.getAll([{ id: 4 }]));
} }, { id: 13, value: function anonymous7(state, event) {
  ((_, useDarkMode2) => {
    useDarkMode2.value = false;
    useDarkMode2.signal();
  })(event, ...state.getAll([{ id: 3 }]));
} }, { id: 14, value: function anonymous8(state, event) {
  ((_, useDarkMode2) => {
    useDarkMode2.value = true;
    useDarkMode2.signal();
  })(event, ...state.getAll([{ id: 3 }]));
} }], soa: [{ "id": 7, "key": 2, "attribute": "onclick" }, { "id": 8, "key": 4, "attribute": "onclick" }, { "id": 2, "key": 5, "attribute": "onclick" }, { "id": 9, "key": 6, "attribute": "onclick" }, { "id": 2, "key": 7, "attribute": "onclick" }, { "id": 10, "key": 8, "attribute": "onclick" }, { "id": 2, "key": 9, "attribute": "onclick" }, { "id": 11, "key": 10, "attribute": "onclick" }, { "id": 2, "key": 11, "attribute": "onclick" }, { "id": 12, "key": 12, "attribute": "onclick" }, { "id": 2, "key": 13, "attribute": "onclick" }, { "id": 13, "key": 14, "attribute": "onclick" }, { "id": 14, "key": 15, "attribute": "onclick" }], ooa: [{ key: 1, attribute: "class", update: (value) => {
