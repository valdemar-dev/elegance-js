let url = "/routing";
export const data = { state: [{ id: 17, value: ["/pages/recipes/cake/page.ts"] }, { id: 18, value: function anonymous(state, event) {
  ...
  })(event, ...state.getAll([{ id: 17 }, { id: 5 }]));
} }], soa: [{ "id": 18, "key": 19, "attribute": "onclick" }] };
if (!globalThis.pd) {
  globalThis.pd = {};
}
;
