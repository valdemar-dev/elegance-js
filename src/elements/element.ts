...
type SpecificProps<Tag extends AllElementTags> = Tag extends keyof SpecificPropsMap
...
type EleganceElementBuilder<Tag extends AllElementTags> =
    ...
    ? (options?: ElementOptions<Tag>) => EleganceElement<Tag, false>
    : (options?: ElementOptionsOrChild<Tag>, ...children: ElementChildren) => EleganceElement<Tag, true>;
...
> {
    ...
    constructor(
        tag: Tag,
        options: ElementOptionsOrChild<Tag> = {} as ElementOptions<Tag>,
        children: ElementChildren | null = null,
    ) {
        this.tag = tag;
        if (isAnElement(options)) {
            ...
            this.options = options as ElementOptions<Tag>;
