...
(() => {
  ...
  var navigateLocally = async (target, pushState = true) => {
    ...
    {
      const newPageLayouts = newArray(selectorNew("template[layout-id]"));
      const oldPageLayouts = newArray(selector("template[layout-id]"));
